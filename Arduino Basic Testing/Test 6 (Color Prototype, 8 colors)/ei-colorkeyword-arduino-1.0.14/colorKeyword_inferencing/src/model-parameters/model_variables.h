...
const char* ei_classifier_inferencing_categories[] = { "Blue", "Cyan", "Green", "Magenta", "Noise2", "Off", "Red", "White", "Yellow", "noise", "unknown" };
...
const ei_learning_block_config_tflite_graph_t ei_learning_block_config_17 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_17_inputs_size = 1;
...
const ei_impulse_t impulse_426794_0 = {
    .project_id = 426794,
    .project_owner = "Andrew Barovic",
    .project_name = "colorKeyword",
    .deploy_version = 14,
    ...
    .tflite_output_features_count = 11,
...
ei_impulse_handle_t impulse_handle_426794_0 = ei_impulse_handle_t( &impulse_426794_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_426794_0;
